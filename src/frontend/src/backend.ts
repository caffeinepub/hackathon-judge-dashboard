...
export class Backend implements backendInterface {
    ...
    async addTeam(arg0: string, arg1: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async addTeams(arg0: Array<string>): Promise<Array<bigint>> {
        if (this.processError) {
            try {
                const result = await this.actor.addTeams(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitRound1Score(arg0: bigint, arg1: Round1Score): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitRound1Score(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitRound2Score(arg0: bigint, arg1: Round2Score): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitRound2Score(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
